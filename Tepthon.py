...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك علش ابشر  @uwrwe')
...
async def join_channel():
    try:
        await Tepthon(JoinChannelRequest("@viptrt"))
    except BaseException:
        pass
...
async def _(event):
      await event.reply("""السـورس يعمـل الــمـــــ🪐ــجـــرة يعمل بنجاح @uwrwe
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.reply("""سنترال : @viptrt"""
)
